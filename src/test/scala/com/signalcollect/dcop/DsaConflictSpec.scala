...
//
//class DsaConflictSpec extends FlatSpec with ShouldMatchers with Checkers {
//
...
//  var runId = 0
//
//  "ConflictDsaB" should "correctly assign colors to a small test graph" in {
//    check(
...
//  }
//
//  "ConflictDsaB" should "correctly assign colors to a 2x2 grid" in {
//    check(
//      (irrelevantParameter: Int) => {
//        runId += 1
//        try {
...
//  }
//
//  "ConflictDsaB" should "correctly assign colors to a random grid" in {
//    check(
//
//      (wWidth: Width) => {
//        val width = wWidth.w
