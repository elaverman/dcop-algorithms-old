...
//        val evaluationGraphParameters =
//          List(GridParameters((0 to 9).toSet, zeroInitialized, debug, 1000)) ++
...
//        for (evaluationGraphParameter <- evaluationGraphParameters) {
...
//            }
//            val evaluationGraph = evaluationGraphParameter match {
//              case gridParameters: GridParameters[Int] =>
//                Grid[Int](optimizer, gridParameters.domain, gridParameters.initialValue, gridParameters.debug, gridParameters.width)
