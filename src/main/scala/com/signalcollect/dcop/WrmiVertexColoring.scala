...
class WrmiVertexColoring[AgentId, Action](changeProbability: Double, rhoValue: Double, etaValue: Double) extends Optimizer[AgentId, Action, SimpleMemoryConfig[AgentId, Action, Double], Double] {
  ...
  override def toString = "WrmiVertexColoringChangeProbability" + changeProbability + "rhoValue" + rhoValue + "etaValue" + etaValue
}
