...
//
//case class DimacsGraph(optimizer: DcopAlgorithm[Int, Int, Option[Nothing]], domain: Set[Int], dimacsFileName: String, initialValue: (Set[Int]) => Int, debug: Boolean) extends ConstraintEvaluationGraph(optimizer) {
//
...
//  def getConstraintGraphData(entities: Traversable[DimacsEntity]): ConstraintGraphData[Int, Nothing] = {
//    var constraintGraphData = ConstraintGraphData[Int, Nothing](Map(), Map())
//    for (e <- entities) {
//      e match {
