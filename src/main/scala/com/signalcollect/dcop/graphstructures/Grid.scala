...
//
//case class Grid[Action](optimizer: Optimizer[Int, Action, Configuration[Int, Action], Double], domain: Set[Action], initialValue: (Set[Action]) => Action, debug: Boolean, width: Int) extends EvaluationGraph(optimizer) {
//
