...
//case class ConstraintGraphData[AgentId, Action](
//    possibleValues: Map[AgentId, Set[Action]], 
//    neighbours: Map[AgentId, Set[AgentId]], 
//    vertexBuilder: (AgentId, Action, Double) => DcopVertex[AgentId, (Action, Double), Action, Double]) {
//
...
//    optimizer1 match {
//
//      case rankedOptimizer1: RankedOptimizer[AgentId, Action, RankedConfig[AgentId, Action]] => {
//        optimizer2 match {
