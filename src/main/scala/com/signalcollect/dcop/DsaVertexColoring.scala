...
case class DsaBProximity(changeProbability: Double)
  extends SimpleProximityDcopAlgorithm[(Int, Int), Int] {
  val schedule = new ParallelRandomAdjustmentSchedule(changeProbability)
  ...
  override def toString = "DsaBVProximity" + changeProbability
}
